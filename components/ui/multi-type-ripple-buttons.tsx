...
const RippleButton: React.FC<RippleButtonProps> = ({
          ...
          style={
            {
              ...
              ["--ripple-duration" as string]: `${ripple ? rippleDuration : 0}ms`,
            } as CSSProperties
          }
        />
      ))}
  ...
  // Default variant
  const baseClasses =
    "relative border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 hover:opacity-90 rounded-lg";
